...
package UUIDs is
   ...
   --  Must be in format "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
   function From_String (From : UUID_String) return UUID;

   --  Creates a UUID from a raw Octet field
   function From_Fields (From : UUID_Field) return UUID;
   ...
   UUID_Nil : constant UUID;

   --  A filled / max reference UUID
   --  FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF
   UUID_Max : constant UUID;

   --  Reference UUIDs
   --  Namespace Reference as per Section 6.6 RFC 9562

   --  6ba7b810-9dad-11d1-80b4-00c04fd430c8
   UUID_DNS  : constant UUID;

   --  6ba7b811-9dad-11d1-80b4-00c04fd430c8
   UUID_URL  : constant UUID;

   --  6ba7b812-9dad-11d1-80b4-00c04fd430c8
   UUID_OID  : constant UUID;

   --  6ba7b814-9dad-11d1-80b4-00c04fd430c8
   UUID_X500 : constant UUID;

   --  C232AB00-9414-11EC-B3C8-9F6BDECED846
   UUID_V1 : constant UUID;

   --  000004D2-92E8-21ED-8100-3FDB0085247E
   UUID_V2 : constant UUID;

   --  5DF41881-3AED-3515-88A7-2F4A814CF09E
   UUID_V3 : constant UUID;

   --  919108F7-52D1-4320-9BAC-F847DB4148A8
   UUID_V4 : constant UUID;

   --  2ED6657D-E927-568B-95E1-2665A8AEA6A2
   UUID_V5 : constant UUID;

   --  1EC9414C-232A-6B00-B3C8-9F6BDECED846
   UUID_V6 : constant UUID;

   --  017F22E2-79B0-7CC3-98C4-DC0C0C07398F
   UUID_V7 : constant UUID;

   --  2489E9AD-2EE2-8E00-8EC9-32D5F69181C0
   UUID_V8_Time_Based : constant UUID;

   --  5C146B14-3C52-8AFD-938A-375D0DF1FBF6
   UUID_V8_Name_Based : constant UUID;

private

   type UUID is tagged record
      Fields : UUID_Field := [others => 0];
   ...
   UUID_Nil : constant UUID := (Fields => [others => 0]);
   UUID_Max : constant UUID := (Fields => [others => 16#FF#]);

   --  6ba7b810-9dad-11d1-80b4-00c04fd430c8
   UUID_DNS  : constant UUID := (Fields => [16#6b#, 16#a7#, 16#b8#, 16#10#,
                                            16#9d#, 16#ad#, 16#11#, 16#d1#,
                                            16#80#, 16#b4#, 16#00#, 16#c0#,
                                            16#4f#, 16#d4#, 16#30#, 16#c8#]);

   --  6ba7b811-9dad-11d1-80b4-00c04fd430c8
   UUID_URL  : constant UUID := (Fields => [16#6b#, 16#a7#, 16#b8#, 16#11#,
                                            16#9d#, 16#ad#, 16#11#, 16#d1#,
                                            16#80#, 16#b4#, 16#00#, 16#c0#,
                                            16#4f#, 16#d4#, 16#30#, 16#c8#]);

   --  6ba7b812-9dad-11d1-80b4-00c04fd430c8
   UUID_OID  : constant UUID := (Fields => [16#6b#, 16#a7#, 16#b8#, 16#12#,
                                            16#9d#, 16#ad#, 16#11#, 16#d1#,
                                            16#80#, 16#b4#, 16#00#, 16#c0#,
                                            16#4f#, 16#d4#, 16#30#, 16#c8#]);

   --  6ba7b814-9dad-11d1-80b4-00c04fd430c8
   UUID_X500 : constant UUID := (Fields => [16#6b#, 16#a7#, 16#b8#, 16#14#,
                                            16#9d#, 16#ad#, 16#11#, 16#d1#,
                                            16#80#, 16#b4#, 16#00#, 16#c0#,
                                            16#4f#, 16#d4#, 16#30#, 16#c8#]);
   UUID_V1 : constant UUID := (Fields => [16#C2#, 16#32#, 16#AB#, 16#00#,
                                          16#94#, 16#14#, 16#11#, 16#EC#,
                                          16#B3#, 16#C8#, 16#9F#, 16#6B#,
                                          16#DE#, 16#CE#, 16#D8#, 16#46#]);
   UUID_V2 : constant UUID := (Fields => [16#00#, 16#00#, 16#04#, 16#d2#,
                                          16#92#, 16#e8#, 16#21#, 16#ed#,
                                          16#81#, 16#00#, 16#3f#, 16#db#,
                                          16#00#, 16#85#, 16#24#, 16#7e#]);
   UUID_V3 : constant UUID := (Fields => [16#5d#, 16#f4#, 16#18#, 16#81#,
                                          16#3a#, 16#ed#, 16#35#, 16#15#,
                                          16#88#, 16#a7#, 16#2f#, 16#4a#,
                                          16#81#, 16#4c#, 16#f0#, 16#9e#]);
   UUID_V4 : constant UUID := (Fields => [16#91#, 16#91#, 16#08#, 16#f7#,
                                          16#52#, 16#d1#, 16#43#, 16#20#,
                                          16#9b#, 16#ac#, 16#f8#, 16#47#,
                                          16#db#, 16#41#, 16#48#, 16#a8#]);
   UUID_V5 : constant UUID := (Fields => [16#2e#, 16#d6#, 16#65#, 16#7d#,
                                          16#e9#, 16#27#, 16#56#, 16#8b#,
                                          16#95#, 16#e1#, 16#26#, 16#65#,
                                          16#a8#, 16#ae#, 16#a6#, 16#a2#]);
   UUID_V6 : constant UUID := (Fields => [16#1E#, 16#C9#, 16#41#, 16#4C#,
                                          16#23#, 16#2A#, 16#6B#, 16#00#,
                                          16#B3#, 16#C8#, 16#9F#, 16#6B#,
                                          16#DE#, 16#CE#, 16#D8#, 16#46#]);
   UUID_V7 : constant UUID := (Fields => [16#01#, 16#7F#, 16#22#, 16#E2#,
                                          16#79#, 16#B0#, 16#7C#, 16#C3#,
                                          16#98#, 16#C4#, 16#DC#, 16#0C#,
                                          16#0C#, 16#07#, 16#39#, 16#8F#]);
   UUID_V8_Time_Based : constant UUID := (Fields =>
                                          [16#24#, 16#89#, 16#E9#, 16#AD#,
                                           16#2E#, 16#E2#, 16#8E#, 16#00#,
                                           16#8E#, 16#C9#, 16#32#, 16#D5#,
                                           16#F6#, 16#91#, 16#81#, 16#C0#]);
   UUID_V8_Name_Based : constant UUID := (Fields =>
